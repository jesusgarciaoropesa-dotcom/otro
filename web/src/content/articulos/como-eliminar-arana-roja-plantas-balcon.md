---
title: "Cómo eliminar la araña roja de las plantas del balcón"
description: "Cómo identificar y eliminar la araña roja en un huerto urbano de balcón, una plaga muy común en climas cálidos y secos, con remedios naturales."
...
<figure><img width="1200" height="670" src="/images/articulos/arana-roja-hoja-punteado.jpg" alt="Hoja de tomatera con punteado amarillento moteado por toda la superficie y una telaraña muy fina, síntoma de araña roja" /><figcaption>El punteado amarillento uniforme y la telaraña muy fina delatan la araña roja</figcaption></figure>
...
- **Punteado amarillento o plateado en las hojas**: pequeñas motas claras dispersas por la superficie de la hoja, resultado de la picadura del ácaro al alimentarse.
- **Telaraña muy fina**: en infestaciones avanzadas, aparece una tela sutil en el envés de la hoja y entre los brotes, mucho más fina que una telaraña normal.
- **Hojas que se secan y caen desde dentro hacia fuera**: a diferencia del estrés por calor, que afecta primero a los bordes, la araña roja deja un aspecto moteado uniforme antes de que la hoja se seque del todo.

Para confirmar, sacude una hoja afectada sobre un papel blanco: si ves puntitos diminutos moviéndose, son los ácaros.

## Por qué es tan común en balcón

La araña roja se reproduce mucho más rápido con calor y humedad ambiental baja, justo las condiciones típicas de un balcón muy soleado en verano, especialmente si las plantas están además estresadas por riego irregular. Los tomates, pimientos y berenjenas en maceta son de los más afectados.
...
- Evita el estrés hídrico: una planta bien regada de forma constante es mucho menos vulnerable que una que pasa de la sequía al riego abundante.
