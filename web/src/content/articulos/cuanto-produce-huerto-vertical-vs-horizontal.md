---
title: "Cuánto produce un huerto vertical frente a uno horizontal"
description: "Comparativa de producción entre un huerto vertical y uno horizontal tradicional en el mismo espacio de balcón, y quién debería elegir cada opción."
...
En una estructura vertical de varios niveles, no todos reciben la misma cantidad de luz: los niveles superiores suelen recibir más sol directo, mientras que los inferiores pueden quedar parcialmente sombreados por los de arriba, especialmente si la estructura está orientada perpendicular al sol. Esto reduce el rendimiento real de los niveles bajos respecto a lo que producirían en una maceta individual sin ese sombreo.
...
Para maximizar la producción total en un balcón pequeño, la estrategia más eficiente suele ser combinar ambos formatos: cultivos de fruto grande en macetas individuales en el suelo, y aromáticas, hojas verdes y fresas aprovechando estructuras verticales para el resto del espacio disponible en altura.
