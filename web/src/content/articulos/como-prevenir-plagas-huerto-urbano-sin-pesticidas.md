---
title: "Cómo prevenir plagas en un huerto urbano sin pesticidas"
description: "Guía completa de prevención de plagas en un huerto urbano de balcón sin usar pesticidas: hábitos de cultivo, plantas repelentes y control natural."
...
## Evita el exceso de riego y nitrógeno

Un sustrato permanentemente húmedo favorece hongos y atrae ciertos insectos, mientras que el exceso de nitrógeno produce un crecimiento blando y tierno especialmente atractivo para el pulgón. Un riego regular pero no excesivo, combinado con un abonado equilibrado, reduce sensiblemente la vulnerabilidad de las plantas.

## Buena ventilación entre macetas

Las plantas demasiado juntas, sin circulación de aire, favorecen la humedad estancada en las hojas y la proliferación de hongos como el oídio. Deja espacio suficiente entre macetas para que el aire circule libremente.
...
Aunque la prevención reduce mucho el riesgo, ninguna medida lo elimina al 100%. Consulta nuestras guías específicas de [cómo eliminar el pulgón de forma natural](/articulos/como-eliminar-pulgon-plantas-balcon-natural/), [cómo eliminar la araña roja](/articulos/como-eliminar-arana-roja-plantas-balcon/), [cómo identificar y eliminar el gusano gris](/articulos/gusano-gris-lechugas-como-eliminarlo/) si encuentras una planta cortada por la base, [cómo identificar y eliminar saltamontes o esperanza](/articulos/como-eliminar-saltamontes-esperanza-plantas-balcon/) si tus hojas desaparecen sin rastro de orugas, y revisa los síntomas en [por qué se caen las hojas de las plantas](/articulos/por-que-se-caen-hojas-plantas-huerto-urbano/) para identificar el problema exacto antes de tratarlo. Si el daño son agujeros y baba, mira [cómo eliminar caracoles y babosas](/articulos/como-eliminar-caracoles-babosas-balcon/); y si ves un ejército de [hormigas](/articulos/como-eliminar-hormigas-macetas-balcon/), casi siempre es señal de pulgón. Ya elegido el tratamiento, consulta nuestra comparativa de [productos ecológicos contra plagas](/articulos/mejores-productos-ecologicos-contra-plagas-huerto/) para saber cuál comprar en cada caso.
